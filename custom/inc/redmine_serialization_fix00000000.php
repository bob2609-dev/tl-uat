    ...
    function addIssue($summary, $description) {
        ...
        try {
            ...
            // Add more details to the description
                ...
                // Set default values for the template variables
                $scenarioId = "N/A"; 
                $subScenario = "N/A";
                $testData = "N/A";
                $expectedResults = "N/A";
                ...
                redmine_log("DESCRIPTION:::".$description);
                
                // Extract values from description if possible
                if (is_string($description)) {
                    if (strpos($description, 'Scenario') !== false) {
