    ...
    function addIssue($summary, $description) {
        ...
        try {
            ...
            // Add more details to the description
                ...
                // Use the bug_notes content exactly as it is, without any reformatting
                // The JavaScript autofill now creates a perfectly formatted template
                $formattedDescription = $description;
                
                // Add timestamp and user info at the end
                // $formattedDescription .= "\n\n" . str_repeat("-", 50) . "\n";
                $formattedDescription .= "\n\n";
                $formattedDescription .= "Submitted by: " . $userName;

                redmine_log("Using bug_notes content as-is for Redmine description");
                redmine_log("Description length: " . strlen($formattedDescription) . " characters");
                redmine_log("Description preview: " . substr($formattedDescription, 0, 300) . "...");
