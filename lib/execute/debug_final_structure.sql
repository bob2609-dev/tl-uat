-- Check actual structure of testplan_tcversions table
DESCRIBE testplan_tcversions;

-- Check what columns actually exist in testplan_tcversions
SELECT 
    'testplan_tcversions columns' as info,
    COLUMN_NAME,
    DATA_TYPE,
    IS_NULLABLE,
    COLUMN_DEFAULT
