...
// NOTE:
// Removed include-time side effects that attempted to start the session and validate CSRF tokens.
// Calling doSessionStart(false) here causes a hard dependency on common.php at include time
// (where doSessionStart() is defined) and breaks when this file is included standalone.
//
// From now on, the caller must:
// - Start the session (e.g. via testlinkInitPage()/doSessionStart() or session_start())
// - Call csrfguard_start() at an appropriate point in the request lifecycle