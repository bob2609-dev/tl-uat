<?php
/**
 * TestLink PHP 8 Init Update
 * This script updates the php8_init.php file to include all necessary functions in one place
 */
...
log_message("Starting php8_init.php update...");
...
// Update config.inc.php to use safe_strftime
...
if (file_exists($configFile)) {
    ...
    if ($found) {
        ...
        log_message("Updated config.inc.php (commented out strftime)");
    } else {
...
log_message("\nUpdate complete! Please restart your web server and clear your browser cache!");
