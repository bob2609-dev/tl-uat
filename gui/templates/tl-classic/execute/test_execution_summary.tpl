        ...
        <div class="filter_panel">
            ...
            <div class="filter-row">
                ...
                <div class="filter_column">
                    ...
                    <input type="text" id="execution_path" name="execution_path" value="{$gui->selectedExecutionPath|escape}" placeholder="Filter by execution path..." onchange="refreshPage()" style="width: 100%;">
                </div>
                <div class="filter_column">
                                        ...
                                        <div id="suite_{$suiteId}_{$planId}" class="suite_content" style="display:none;">
                                            <table class="simple">
                                                <tr>
                                                    ...
                                                    <th onclick="sortBy('execution_path')" style="cursor:pointer">
                                                        Execution Path
                                                        {if $gui->orderBy=='execution_path'}{if $gui->orderDir=='ASC'} &#9650; {else} &#9660; {/if}{/if}
                                                    </th>
                                                ...
                                                {foreach from=$suite.executions item=execution}
                                                    <tr class="status_{$execution.execution_status}">
                                                        ...
                                                        <td>{$execution.execution_path|escape|default:'N/A'}</td>
