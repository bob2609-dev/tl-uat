...
<div class="vertical_menu" style="float: right; margin:0px 0px 10px 10px;width: 320px;">
  ...
  {if $display_right_block_2}
	...
	{if $gui->grants.testplan_execute == "yes" || 
		...
		{* Optimized Execution Module - High Performance Alternative *}
		<a href="lib/execute/optimized_execution_module.php" class="list-group-item" style="{$aStyle}">
			<span style="color: rgb(40, 167, 69); font-weight: bold;">⚡ Optimized Execution</span>
		</a>
		<a href="lib/execute/optimized_execution_standalone.html" class="list-group-item" style="{$aStyle}" target="_blank">
  ...
  {* New Section - Visually Separated *}
  <br/><br/>
  <div class="list-group" style="{$divStyle}">
    <div style="padding: 10px 15px; background-color: #f8f9fa; border-left: 4px solid #007bff; margin-bottom: 10px;">
      <h6 style="margin: 0; color: #495057; font-weight: bold;">Reports</h6>
		...
		{if $gui->grants.testplan_metrics == "yes"}
			<a href="lib/execute/test_execution_summary.php" class="list-group-item" style="{$aStyle}">Execution Summary</a>
		{/if} 
    {* Optimized Execution Summary Added - 2025-01-24 *}
    <a href="lib/execute/test_execution_summary_optimized_standalone.html" class="list-group-item" style="{$aStyle}">  <span style="color: rgb(40, 167, 69);font-weight: bold;">Optimized! </span> Execution Summary </a>
    {* <a href="lib/execute/suite_execution_summary.php" class="list-group-item" style="{$aStyle}">
    <span style="color: red;">New! </span>
    Test Suite Execution Summary</a> *}

    {* <a href="lib/execute/suite_execution_summary_updated.php" class="list-group-item" style="{$aStyle}">
    <span style="color: rgb(59, 123, 243);">New! </span>
    Test Suite Execution Summary </a> *}
    <a href="lib/execute/suite_execution_summary_proc.php" class="list-group-item" style="{$aStyle}">  <span style="color: rgb(243, 111, 59);font-weight: bold;">New! </span> Test Suite Execution Summary </a>
    <a href="lib/execute/suite_execution_summary_optimized_standalone.html" class="list-group-item" style="{$aStyle}">  <span style="color: rgb(40, 167, 69);font-weight: bold;">Optimized! </span> <span style="color: rgb(243, 111, 59);font-weight: bold;">Test Suite Execution Summary</span></a>
    {* <a href="lib/execute/test_execution_summary_copy.php" class="list-group-item" style="{$aStyle}">Execution Summary with Hierarchy</a> *}
    {* Tester Execution Report Added - 2025-01-27 *}
			<a href="lib/execute/tester_execution_report_professional.html" class="list-group-item" style="{$aStyle}">  <span style="color: rgb(40, 167, 69);font-weight: bold;">New! </span> <span style="color: rgb(23, 162, 184);font-weight: bold;">👤  Tester Execution Report</span></a>
			{* <a href="lib/execute/tester_execution_report_standalone.html" class="list-group-item" style="{$aStyle}">  <span style="color: rgb(40, 167, 69);font-weight: bold;">New! </span> <span style="color: rgb(23, 162, 184);font-weight: bold;">👤 Tester Execution Report</span></a> *}
    <a href="lib/execute/tester_execution_report_breakdown.html" class="list-group-item" style="{$aStyle}">  <span style="color: rgb(40, 167, 69);font-weight: bold;">New! </span> <span style="color: rgb(23, 162, 184);font-weight: bold;">🔍 Tester Execution Breakdown</span></a>
    {* <a href="lib/execute/tester_execution_report_standalone.html" class="list-group-item" style="{$aStyle}">  <span style="color: rgb(40, 167, 69);font-weight: bold;">New! </span> <span style="color: rgb(23, 162, 184);font-weight: bold;">👤 Tester Execution Report</span></a> *}
    <a href="lib/execute/other_custom_reports.php" class="list-group-item" style="{$aStyle}"><span style="color: rgb(243, 111, 59); font-weight: bold;">Other Custom Reports</span></a>
  </div>
  <br/>
