...
<form method="post" id="filter_panel_form" name="filter_panel_form" {if $control->formAction }
    action="{$control->formAction}" {/if} {if $control->filters.filter_result}
  onsubmit="return validateForm(this);document.getElementById('filter_result_method').disabled=false;" {/if}>
  ...
  {if $control->draw_bulk_update_button}
    <input type="button" value="{$labels.btn_bulk_update_to_latest_version}" name="doBulkUpdateToLatest"
 ...
 *}
            ...
            <tr>
              ...
              <td>
                ...
                <input type="checkbox" id="cbsetting_refresh_tree_on_action" name="setting_refresh_tree_on_action"
                  {if $control->settings.setting_refresh_tree_on_action.selected} checked {/if} style="font-size: 90%;"
            ...
            <tr>
              ...
              <td>
                ...
                <input type="checkbox" id="cbsetting_get_parent_child_relation" name="setting_get_parent_child_relation"
                  {if $control->settings.setting_get_parent_child_relation.selected} checked {/if} style="font-size: 90%;"
                  onclick="this.form.submit()" />
              </td>
            </tr>
          {/if}
            ...
            <tr>
              ...
              <td>
                {if $control->draw_export_testplan_button}
                  <image src="{$tlImages.export}" title="{$labels.btn_export_testplan_tree}" onclick="javascript: openExportTestPlan('export_testplan','{$session.testprojectID}',
  ...
  {if $control->display_filters}
    ...
    <div id="filter_panel">
      ...
      <div id="filters" class="x-panel-body exec_additional_info" style="padding-top: 3px;overflow: visible;">
        ...
        <table class="smallGrey" style="width:98%;">
          ...
          {if $control->filters.filter_tc_id}
            <tr>
              ...
              <td><input type="text" name="filter_tc_id" size="{#TC_ID_SIZE#}" maxlength="{#TC_ID_MAXLEN#}"
          ...
          {if $control->filters.filter_testcase_name}
            <tr>
              ...
              <td><input type="text" name="filter_testcase_name" size="{#TC_TITLE_SIZE#}" maxlength="{#TC_TITLE_MAXLEN#}"
          ...
          {if $control->filters.filter_keywords}
            <tr>
              ...
              <td><select class="chosen-select" name="filter_keywords[]" title="{$labels.keywords_filter_help}"
                  multiple="multiple" size="{$control->filters.filter_keywords.size}">
          ...
          {if $control->filters.filter_workflow_status}
            <tr>
              <td>{$labels.status}</td>
              <td>
                <select class="chosen-select" id="filter_workflow_status" {if $control->advanced_filter_mode}
                    name="filter_workflow_status[]" multiple="multiple" size="{$control->filter_item_quantity}">
                  {else}
          ...
          {if $control->filters.filter_importance}
            <tr>
              ...
              <td>
                <select class="chosen-select" id="filter_importance" {if $control->advanced_filter_mode}
                    name="filter_importance[]" multiple="multiple" size="{$control->filters.filter_importance.size}">
                  {else}
              ...
              <td>
                ...
                {else}
                  ...
                  <input type="checkbox" id="filter_assigned_user_include_unassigned"
                    ...
                    {if $control->filters.filter_assigned_user.filter_assigned_user_include_unassigned} checked="checked"
                    {/if} />
          ...
          {if $control->filters.filter_bugs}
            <tr>
              ...
              <td><input type="text" name="filter_bugs" size="{#BUGS_FILTER_SIZE#}" maxlength="{#BUGS_FILTER_MAXLEN#}"
                  placeholder="{$labels.hint_list_of_bugs}" value="{$control->filters.filter_bugs.selected|escape}" />
              </td>
            </tr>
          {/if}
          ...
          {if $control->filters.filter_result}
            ...
            <tr>
              <td>&nbsp;</td>
            </tr> {* empty row for a little separation *}

            <tr>
              <td>{$labels.filter_result}</td>
              <td>
                <select class="chosen-select" id="filter_result_result" {if $control->advanced_filter_mode}
                    name="filter_result_result[]" multiple="multiple" size="{$control->filter_item_quantity}">
                  {else}
        ...
        <div>
          <input type="submit" value="{$labels.btn_apply_filter}" id="doUpdateTree" name="doUpdateTree"
            style="font-size: 90%;" />

          <input type="submit" value="{$labels.btn_reset_filters}" id="doResetTree" name="btn_reset_filters"
            style="font-size: 90%;" />

          {if $control->filters.filter_custom_fields}
            <input type="submit" value="{$control->filters.filter_custom_fields.btn_label}" id="doToggleCF"
          ...
          {if $control->filter_mode_choice_enabled}
            ...
            <input type="submit" id="toggleFilterMode" name="{$control->filter_mode_button_name}"
              value="{$control->filter_mode_button_label}" style="font-size: 90%;" />
          {/if}
    ...
    <div id="filters" class="x-panel-body exec_additional_info" style="padding-top: 3px; overflow: visible;">
      ...
      <table class="smallGrey" style="width:98%;">
        ...
        <tr>
          ...
          <td><input type="text" name="filter_doc_id" size="{#REQ_DOCID_SIZE#}" maxlength="{#REQ_DOCID_MAXLEN#}"
        ...
        <tr>
          <td>{$labels.title}</td>
          <td><input type="text" name="filter_title" size="{#REQ_NAME_SIZE#}" maxlength="{#REQ_NAME_MAXLEN#}"
        ...
        <tr>
          <td>{$labels.status}</td>
          <td>
            <select class="chosen-select" id="filter_status" {if $control->advanced_filter_mode} name="filter_status[]"
              multiple="multiple" size="{$control->filter_item_quantity}">
              {else}
              name="filter_status">
              {/if}
        ...
        <tr>
          ...
          <td>
            <select class="chosen-select" id="filter_type" {if $control->advanced_filter_mode} name="filter_type[]"
              multiple="multiple" size="{$control->filter_item_quantity}">
              {else}
              name="filter_type">
              {/if}
        ...
        <tr>
          ...
          <td>
            <select class="chosen-select" id="filter_spec_type" {if $control->advanced_filter_mode}
              name="filter_spec_type[]" multiple="multiple" size="{$control->filter_item_quantity}">
              {else}
        ...
        <tr>
          ...
          <td><input type="text" name="filter_coverage" size="{#COVERAGE_SIZE#}" maxlength="{#COVERAGE_MAXLEN#}"
        ...
        <tr>
          ...
          <td>
            <select class="chosen-select" id="filter_relation" {if $control->advanced_filter_mode}
              name="filter_relation[]" multiple="multiple" size="{$control->filter_item_quantity}">
              {else}
  ...
  <input type="button" style="font-size: 90%;" name="removen_all_tester_assignments" value="{$labels.btn_bulk_remove}"
  ...
  <input type="button" style="font-size: 90%;" name="copy_tester_assignments" value="{$labels.btn_bulk_copy}"
