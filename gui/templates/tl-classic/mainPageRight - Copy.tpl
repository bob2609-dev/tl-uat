...
<div class="vertical_menu" style="float: right; margin:0px 0px 10px 10px;width: 320px;">
  ...
  {if $display_right_block_2}
	...
	{if $gui->grants.testplan_execute == "yes" || 
      ...
      {* Optimized Version Added - 2025-01-24 *}
      <a href="lib/execute/suite_execution_summary_optimized_standalone.html" class="list-group-item" style="{$aStyle}">  <span style="color: rgb(40, 167, 69);font-weight: bold;">Optimized! </span> Test Suite Execution Summary (Fast UI) </a>
