...
-- Created: 2025-02-23
-- Safe version without sample data that might cause foreign key errors
...
-- Note: No sample data is included to avoid foreign key constraint errors.
-- You can add sample integrations and mappings after the tables are created
-- using the management interface or by inserting data manually.
