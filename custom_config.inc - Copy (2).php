...
// Register our custom SSL fix class with TestLink
require_once('lib/issuetrackerintegration/redminerestSslFix.class.php');
$tlCfg->issueTrackerIntegration = new stdClass();
$tlCfg->issueTrackerIntegration->enabled = true;
$tlCfg->issueTrackerIntegration->interfaceClass = array();
$tlCfg->issueTrackerIntegration->interfaceClass['REDMINERESTSSLFIX'] = 'redminerestSslFix';
