...
$tlCfg->cookie->domain = ''; // Empty means use the current domain (works for localhost and prod)
$tlCfg->cookie->secure = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on') ? true : false;
$tlCfg->cookie->httponly = true;
...
// Force HTTPS-aware behavior for session cookies and URL generation
// Ensures PHPSESSID and auth cookies are set with Secure when serving over https
 ...
 */
$tlCfg->log_path = 'C:\xampp\htdocs\tl-uat\logs'; /* Maka example */
 ...
 *
 */                            
$tlCfg->loggerFilter = array('file' => array('DEBUG','INFO','WARNING','ERROR','AUDIT'));
...
$tlCfg->exec_cfg->tcases_counters_mode_domain['without_platforms'] =
  array('USE_LATEST_EXEC_ON_CONTEX_FOR_COUNTERS',
        ...
        // Use simplest counter calculation mode
...
$tlCfg->spec_cfg->automatic_tree_refresh = DISABLED;
...
$tlCfg->attachments->allowed_files = 'doc,DOC,xls,XLS,gif,GIF,png,PNG,jpg,JPG,xlsx,XLSX,csv,CSV,jpeg,JPEG,pdf,PDF,doc,DOC,xml,XML,ppt,PPT,pptx,PPTX,eml,EML';
 ...
 *
 **/
$g_repositoryPath = 'C:\xampp\htdocs\tl-uat\upload_area';  /* unix example */
...
$tlCfg->tree_filter_cfg->requirements->automatic_tree_refresh = DISABLED;
